	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{image : 'assets/img/sliders/slider1.jpg', title : '<div class="hero-text"><h2 class="hero-heading">KUSTĪBA</h2><p>Tā notiek laikā un telpā</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider3.gif', title : '<div class="hero-text"><h2 class="hero-heading">ANIMĀCIJA</h2><p>Kustības attēlošanas paņēmieni un īpatnības</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider2.jpg', title : '<div class="hero-text"><h2 class="hero-heading">EKSPERIMENTI</h2><p>Gaismas kustība</p></div>', thumb : '', url : ''}  
						],
		});
